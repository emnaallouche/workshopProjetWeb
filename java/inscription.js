...
function validatePhoneNumber() {
    ...
    if (!pattern.test(TelephoneValue)) {
        TelephoneError.innerHTML = "<span style='color:red'>Le numero de telephone doit être composé de 10 chiffres</span>";
    } else {
...
function validatePassword() {
    ...
    if (PasswordValue.length < 8) {
        PasswordError.innerHTML = "<span style='color:red'>Le mot de passe doit contenir au moins 8 caracteres</span>";
        return;
    }
